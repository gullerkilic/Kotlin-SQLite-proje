    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if (gelenBilgi.equals("menudengeldim")){
                //yeni ibr yemek ekleme

                yemekismiText.setText("")
                yemekmalzemeText.setText("")
                button.visibility = View.VISIBLE

                val gorselSecmeArkaplani =BitmapFactory.decodeResource(context?.resources,R.drawable.gorselyukle)




            } else{
                //daha önce oluşturulan yemeği görme
                ...
                context?.let {
                    ...
                    try {
                        ...
                        val malzemeIndex = cursor.getColumnIndex("yemekMalzemeleri")
                        val yemekGorseli = cursor.getColumnIndex("gorsel")

                        while (cursor.moveToNext()){
                            yemekismiText.setText(cursor.getString(yemekIsmiIndex))
                            yemekmalzemeText.setText(cursor.getString(malzemeIndex))
        ...
        if (secilenbitmap != null){
            ...
            try {
                context?.let {
                    ...
                    val sqString = "INSERT INTO yemekler(yemekIsmi, yemekMalzemeleri, gorsel) VALUES (?,?,?)"
